...
const Reply: React.FC<ReplyProps> = ({
  ...
  return (
    <div className="flex items-start gap-2.5">
      ...
      <button
        type="button"
        className="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-500 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-600"
      ...
      {isOpen && (
        <div
          id="dropdownDots"
          className="z-10 absolute top-0 right-0 w-40 rounded-lg shadow bg-white dark:bg-gray-700"
        >
